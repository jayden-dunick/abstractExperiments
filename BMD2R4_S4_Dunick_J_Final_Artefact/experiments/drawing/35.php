<?php 
    ...
    include '../../php/drawings/comments56.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(35).png" alt="Drawing 35">
        </article>
       <article><h4>Baby moose</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/quickDrawings3.png" alt="Gif 35"><article class="comments">
            <?php 
