<?php 
    ...
    include '../../php/drawings/comments44.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(23).png" alt="Drawing 23">
        </article>
       <article><h4>Riding into a rift</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif23.gif" alt="Gif 23"><article class="comments">
            <?php 
