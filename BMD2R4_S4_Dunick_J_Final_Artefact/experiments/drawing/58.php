<?php 
    ...
    include '../../php/drawings/comments79.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(58).png" alt="Drawing 58">
        </article>
       <article><h4>Pit of snakes</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif58.gif" alt="Gif 58"><article class="comments">
            <?php 
