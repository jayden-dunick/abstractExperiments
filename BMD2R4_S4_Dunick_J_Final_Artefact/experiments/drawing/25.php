<?php 
    ...
    include '../../php/drawings/comments46.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(25).png" alt="Drawing 25">
        </article>
       <article><h4>Robot vacuum with knife</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif25.gif" alt="Gif 25"><article class="comments">
            <?php 
