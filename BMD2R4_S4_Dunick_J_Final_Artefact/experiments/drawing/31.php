<?php 
    ...
    include '../../php/drawings/comments52.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(31).png" alt="Drawing 31">
        </article>
       <article><h4>Angry predator</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif31.gif" alt="Gif 31"><article class="comments">
            <?php 
