<?php 
    ...
    include '../../php/drawings/comments77.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(56).png" alt="Drawing 56">
        </article>
       <article><h4>Zombie Cat</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif56.gif" alt="Gif 56"><article class="comments">
            <?php 
