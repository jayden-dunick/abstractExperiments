<?php 
    ...
    include '../../php/drawings/comments69.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(48).png" alt="Drawing 48">
        </article>
       <article><h4>Tiny frog on a flower</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif48.gif" alt="Gif 48"><article class="comments">
            <?php 
