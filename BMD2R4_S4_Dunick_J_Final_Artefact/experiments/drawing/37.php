<?php 
    ...
    include '../../php/drawings/comments58.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(37).png" alt="Drawing 37">
        </article>
       <article><h4>Tree civilisation</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/quickDrawings3.png" alt="Gif 37"><article class="comments">
            <?php 
