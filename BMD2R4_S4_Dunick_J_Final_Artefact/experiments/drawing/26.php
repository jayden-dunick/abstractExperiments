<?php 
    ...
    include '../../php/drawings/comments47.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(26).png" alt="Drawing 26">
        </article>
       <article><h4>Cloud dragon</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif26.gif" alt="Gif 26"><article class="comments">
            <?php 
