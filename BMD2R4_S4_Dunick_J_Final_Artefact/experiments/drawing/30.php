<?php 
    ...
    include '../../php/drawings/comments51.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(30).png" alt="Drawing 30">
        </article>
       <article><h4>Tent in a park</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif30.gif" alt="Gif 30"><article class="comments">
            <?php 
