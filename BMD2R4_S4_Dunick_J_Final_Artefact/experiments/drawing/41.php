<?php 
    ...
    include '../../php/drawings/comments62.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(41).png" alt="Drawing 41">
        </article>
       <article><h4>God of lightning</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif41.gif" alt="Gif 41"><article class="comments">
            <?php 
