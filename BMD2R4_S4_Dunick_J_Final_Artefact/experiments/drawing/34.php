<?php 
    ...
    include '../../php/drawings/comments55.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(34).png" alt="Drawing 34">
        </article>
       <article><h4>Tired cat</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/quickDrawings3.png" alt="Gif 34"><article class="comments">
            <?php 
