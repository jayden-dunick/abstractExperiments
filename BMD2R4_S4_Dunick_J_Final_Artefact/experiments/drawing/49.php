<?php 
    ...
    include '../../php/drawings/comments70.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(49).png" alt="Drawing 49">
        </article>
       <article><h4>Deer plague doctor</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif49.gif" alt="Gif 49"><article class="comments">
            <?php 
