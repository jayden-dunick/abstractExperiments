<?php 
    ...
    include '../../php/drawings/comments84.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(63).png" alt="Drawing 63">
        </article>
       <article><h4>Upping soldier moral</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif63.gif" alt="Gif 63"><article class="comments">
            <?php 
