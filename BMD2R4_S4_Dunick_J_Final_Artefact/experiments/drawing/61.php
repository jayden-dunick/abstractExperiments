<?php 
    ...
    include '../../php/drawings/comments82.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(61).png" alt="Drawing 61">
        </article>
       <article><h4>Cowboy vs Alien</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif61.gif" alt="Gif 61"><article class="comments">
            <?php 
