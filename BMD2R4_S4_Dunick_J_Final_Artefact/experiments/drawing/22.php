<?php 
    ...
    include '../../php/drawings/comments43.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(22).png" alt="Drawing 22">
        </article>
       <article><h4>Ice cube in puddle</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif22.gif" alt="Gif 22"><article class="comments">
            <?php 
