<?php 
    ...
    include '../../php/drawings/comments42.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(21).png" alt="Drawing 21">
        </article>
       <article><h4>Flying ankylosaurus</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif21.gif" alt="Gif 21"><article class="comments">
            <?php 
