<?php 
    ...
    include '../../php/drawings/comments74.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(53).png" alt="Drawing 53">
        </article>
       <article><h4>Isometric western tv set</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif53.gif" alt="Gif 53"><article class="comments">
            <?php 
