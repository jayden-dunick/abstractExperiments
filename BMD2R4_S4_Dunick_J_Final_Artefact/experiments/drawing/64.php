<?php 
    ...
    include '../../php/drawings/comments85.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(64).png" alt="Drawing 64">
        </article>
       <article><h4>Zap the sun</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif64.gif" alt="Gif 64"><article class="comments">
            <?php 
