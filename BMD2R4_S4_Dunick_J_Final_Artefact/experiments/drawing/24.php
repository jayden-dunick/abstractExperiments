<?php 
    ...
    include '../../php/drawings/comments45.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(24).png" alt="Drawing 24">
        </article>
       <article><h4>Angler fish salesman</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif24.gif" alt="Gif 24"><article class="comments">
            <?php 
