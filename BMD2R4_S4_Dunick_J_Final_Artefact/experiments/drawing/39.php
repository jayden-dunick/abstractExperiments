<?php 
    ...
    include '../../php/drawings/comments60.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(39).png" alt="Drawing 39">
        </article>
       <article><h4>Highway sunset</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/quickDrawings3.png" alt="Gif 39"><article class="comments">
            <?php 
