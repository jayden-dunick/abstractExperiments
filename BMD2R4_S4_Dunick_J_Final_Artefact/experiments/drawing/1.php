<?php 
    ...
    include '../../php/drawings/comments22.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(1).png" alt="Drawing1">
        </article>
       <article><h4>1 digit alarm clock</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/quickDrawings1.png" alt="Quick Drawings session 1">
