<?php 
    ...
    include '../../php/drawings/comments39.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(18).png" alt="Drawing 18">
        </article>
       <article><h4>Wizard shrink ray</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif18.gif" alt="Gif 18"><article class="comments">
            <?php 
