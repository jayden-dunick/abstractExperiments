<?php 
    ...
    include '../../php/drawings/comments41.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(20).png" alt="Drawing 20">
        </article>
       <article><h4>Fishing jellyfish</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif20.gif" alt="Gif 20"><article class="comments">
            <?php 
