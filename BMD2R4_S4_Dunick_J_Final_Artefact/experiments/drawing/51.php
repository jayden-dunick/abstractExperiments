<?php 
    ...
    include '../../php/drawings/comments72.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(51).png" alt="Drawing 51">
        </article>
       <article><h4>Cat scared of guitar</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif51.gif" alt="Gif 51"><article class="comments">
            <?php 
