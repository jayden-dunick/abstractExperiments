<?php 
    ...
    include '../../php/drawings/comments71.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(50).png" alt="Drawing 50">
        </article>
       <article><h4>Sky island civilisation</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif50.gif" alt="Gif 50"><article class="comments">
            <?php 
