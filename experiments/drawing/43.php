<?php 
    ...
    include '../../php/drawings/comments64.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(43).png" alt="Drawing 43">
        </article>
       <article><h4>Dancing on a tumbleweed</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif43.gif" alt="Gif 43"><article class="comments">
            <?php 
