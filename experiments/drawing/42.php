<?php 
    ...
    include '../../php/drawings/comments63.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(42).png" alt="Drawing 42">
        </article>
       <article><h4>Conveyor belt sushi</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif42.gif" alt="Gif 42"><article class="comments">
            <?php 
