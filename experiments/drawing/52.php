<?php 
    ...
    include '../../php/drawings/comments73.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(52).png" alt="Drawing 52">
        </article>
       <article><h4>Cat shadow</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif52.gif" alt="Gif 52"><article class="comments">
            <?php 
