<?php 
    ...
    include '../../php/drawings/comments81.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(60).png" alt="Drawing 60">
        </article>
       <article><h4>Travel by boat</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif60.gif" alt="Gif 60"><article class="comments">
            <?php 
