<?php 
    ...
    include '../../php/drawings/comments53.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(32).png" alt="Drawing 32">
        </article>
       <article><h4>Incomplete painting</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif32.gif" alt="Gif 32"><article class="comments">
            <?php 
