<?php 
    ...
    include '../../php/drawings/comments40.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(19).png" alt="Drawing 19">
        </article>
       <article><h4>Water dam</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif19.gif" alt="Gif 19"><article class="comments">
            <?php 
