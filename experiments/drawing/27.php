<?php 
    ...
    include '../../php/drawings/comments48.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(27).png" alt="Drawing 27">
        </article>
       <article><h4>Speeding through town</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif27.gif" alt="Gif 27"><article class="comments">
            <?php 
