<?php 
    ...
    include '../../php/drawings/comments50.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(29).png" alt="Drawing 29">
        </article>
       <article><h4>Take off the mask</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif29.gif" alt="Gif 29"><article class="comments">
            <?php 
