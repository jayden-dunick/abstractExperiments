<?php 
    ...
    include '../../php/drawings/comments83.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(62).png" alt="Drawing 62">
        </article>
       <article><h4>Destroyed tracks</h4>
      <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif62.gif" alt="Gif 62"><article class="comments">
            <?php 
