<?php 
    ...
    include '../../php/drawings/comments38.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(17).png" alt="Drawing 17">
        </article>
       <article><h4>Zombie hoard</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif17.gif" alt="Gif 17"><article class="comments">
            <?php 
