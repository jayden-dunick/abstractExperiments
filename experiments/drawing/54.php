<?php 
    ...
    include '../../php/drawings/comments75.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(54).png" alt="Drawing 54">
        </article>
       <article><h4>Deserted alien market</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif54.gif" alt="Gif 54"><article class="comments">
            <?php 
