<?php 
    ...
    include '../../php/drawings/comments49.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(28).png" alt="Drawing 28">
        </article>
       <article><h4>Desserted ruins</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif28.gif" alt="Gif 28"><article class="comments">
            <?php 
