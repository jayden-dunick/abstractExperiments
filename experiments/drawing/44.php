<?php 
    ...
    include '../../php/drawings/comments65.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(44).png" alt="Drawing 44">
        </article>
       <article><h4>Room of mirrors</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif44.gif" alt="Gif 44"><article class="comments">
            <?php 
