<?php 
    ...
    include '../../php/drawings/comments67.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(46).png" alt="Drawing 46">
        </article>
       <article><h4>Alien Angel</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif46.gif" alt="Gif 46"><article class="comments">
            <?php 
