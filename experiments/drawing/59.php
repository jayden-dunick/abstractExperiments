<?php 
    ...
    include '../../php/drawings/comments80.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(59).png" alt="Drawing 59">
        </article>
       <article><h4>Cat boxing ring</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif59.gif" alt="Gif 59"><article class="comments">
            <?php 
