<?php 
    ...
    include '../../php/drawings/comments76.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(55).png" alt="Drawing 55">
        </article>
       <article><h4>Carnivorous Plant</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif55.gif" alt="Gif 55"><article class="comments">
            <?php 
