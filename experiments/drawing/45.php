<?php 
    ...
    include '../../php/drawings/comments66.inc.php'
?>
    ...
    <nav>
     ...
     <section class="experiment">
       ...
       <article class="drawing">
            <img src="../../images/drawing/drawing%20(45).png" alt="Drawing 45">
        </article>
       <article><h4>Feeding a bunny</h4>
       <h5>Quick Illustration</h5></article>
    </section>
     <section class="experiment"><img src="../../images/drawing/gif45.gif" alt="Gif 45"><article class="comments">
            <?php 
